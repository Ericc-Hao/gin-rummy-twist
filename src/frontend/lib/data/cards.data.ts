export interface Card {
  ...
  export const CARDS: Card[] = [
    ...
    { order:14, point: 12, name: 'hearts-Q', image: '/cards-image/Hearts/Hearts-Q.svg.png' ,color: 'text-red-600' , text: 'Q'  },
    { order:15, point: 12, name: 'hearts-K', image: '/cards-image/Hearts/Hearts-K.svg.png',color: 'text-red-600' , text: 'K'   },
    { order:16, point: 12, name: 'hearts-C', image: '/cards-image/Hearts/Hearts-C.svg.png',color: 'text-red-600' , text: 'C'   },
    ...
    { order:14, point: 12, name: 'spades-Q', image: '/cards-image/spades/Spades-Q.svg.png',color: 'text-black' , text: 'Q'  },
    { order:15, point: 12, name: 'spades-K', image: '/cards-image/spades/Spades-K.svg.png',color: 'text-black' , text: 'K'  },
    { order:16, point: 12, name: 'spades-C', image: '/cards-image/spades/Spades-C.svg.png',color: 'text-black' , text: 'C'  },
